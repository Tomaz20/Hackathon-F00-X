...
insert into tratamento(id_Tratamento,descricao)
					values(1,'Doença Cardíaca Medicamentos como: atorvastatina cálcica, lipitor e sinvastatina. Não é recomendável a auto-medicação devendo ser seguidas as recomendações do médico'),
						 (2,'Gastroenterite Medicamentos como: Androfloxin, cefalotina, ceftriaxona dissódica, ceftriaxona sódica, ciprofloxacino. Não é recomendável a auto-medicação devendo ser seguidas as recomendações do médico'),
						 (3,'Otite Quando bacteriana, podem ser receitados antibióticos. Se as otites são recorrentes pode ser recomendada a drenagem de líquido do ouvido médio. A remoção da adenoide pode 
                         ajudar crianças com otite de repetição ou fluido atrás do tímpano. Medicamentos como: amoxilina, bactrim, broncho-vaxom, cetropofeno, paracetamol, entre outros.
                         Não é recomendável a auto-medicação devendo ser seguidas as recomendações do médico'),
						 (4,'Amigdalite Medicamentos anti-inflamatórios no caso de uma amigdalite simples. No caso de maior gravidade pode ser necessário o recurso a antibióticos. Medicamentos como:
                         amoxicilina+ clavulanato de potássio, arflex, benzetacil, cetoprofeno, doxiclina, eritromicina, ibuprofeno, paracetamol. Não é recomendável a auto-medicação devendo ser seguidas as recomendações do médico'),
						 (5,'Cirrose O tratamento consiste em medidas para evitar o avanço do problema, não sendo possível a reversão deste. A cura da cirrose só é possível com um transplante de fígado.
                         É indicado evitar excesso de sal, fritos e carnes vermelhas. Consumo de álcool é proibido. Refeições devem ser realizadas em pequenas porções divididas ao longo do dia. Medicamentos como:
                         aldactone, diurix, epocler, espironolactona, hidroclorotiazida. Não é recomendável a auto-medicação devendo ser seguidas as recomendações do médico'),
						 (6,'Hepatite Não existe tratamento para a forma aguda da hepatite. É importante o repouso, utilização de dieta pobre em gorduras, e rica em carbohidratos. É proibida a ingestão de álcool. 
                         Medicamentos como: epocler e prednisona. Não é recomendável a auto-medicação devendo ser seguidas as recomendações do médico'),
						 (7,'Pneumonia É requerido o uso de antibioticos e, por vezes, o internamento hospitalar. Medicamentos como: acetilcisteína, ampicilina sódica, azitromicina, bisolvon, cefalotina, clavulin, claritromicina,
 ...
 insert into sintoma(id_sintoma,nome)
		           values(1,''),
						 (2,''),
						 (3,''),
						 (4,''),
